\begin{minipage}{0.75\textwidth}
  \begin{tikzpicture}[scale=1.0, baseline=(current bounding box.north)]
    \begin{scope}[rotate=<<rotationAngle>>]
      ...
      <<anglestext>>
      % %% Point A
      % \draw pic["$<<alabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=te--A--p1e};
      % \draw pic["$<<blabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=p1e--A--ts};
      % \draw pic["$<<clabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=ts--A--p1s};
      % \draw pic["$<<dlabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=p1s--A--te};
      
      % %%  Point B
      % \draw pic["$<<elabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=te--B--p2e};
      % \draw pic["$<<flabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=p2e--B--ts};
      % \draw pic["$<<glabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=ts--B--p2s};
      % \draw pic["$<<hlabel>>$", draw=black, -, angle eccentricity=2.0, angle radius=0.4cm] {angle=p2s--B--te};
