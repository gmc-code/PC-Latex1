...
\begin{tikzpicture}[scale=0.75]
    ...
    % arrow
    \draw[-{To[scale=1.3, bend]},line width=1pt, color=black] (a.north)  .. controls  +(north:\jumpheight mm) and +(north:\jumpheight mm) .. node[above=2pt,text height=10pt,font=\large] {$\changevaltxt$} (b.north);
