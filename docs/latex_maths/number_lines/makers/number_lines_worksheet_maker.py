...
def main():
    ...
    # questions
      # questions
    tex_output_path = currfile_dir / f"nlWS_{filename}_q.tex"
    pdf_path = currfile_dir / f"nlWS_{filename}_q.pdf"
    png_path = currfile_dir / f"nlWS_{filename}_q.png"
    aux_path = currfile_dir / "temp"
    # answers
    tex_output_path_ans = currfile_dir / f"nlWS_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"nlWS_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"nlWS_{filename}_ans.png"
