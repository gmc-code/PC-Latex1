...
tex_template_path = currfile_dir / "right_triangle_template.tex"
texans_template_path = currfile_dir / "right_triangle_template.tex"
tex_diagram_template_path = currfile_dir / "right_triangle_diagram_template.tex"
...
def main():
    filename = input("Enter the base filename to be added to the prefix right_triangle_: \n")
    if not filename:
        filename = "1"  # "right_triangle_1_q and right_triangle_1_ans as default file"
    # set names of files that are made
    # questions
    tex_output_path = currfile_dir / f"right_triangle_{filename}_q.tex"
    pdf_path = currfile_dir / f"right_triangle_{filename}_q.pdf"
    png_path = currfile_dir / f"right_triangle_{filename}_q.png"
    aux_path = currfile_dir / "temp"
    # answers
    tex_output_path_ans = currfile_dir / f"right_triangle_{filename}_ans.tex"
    pdf_path_ans = currfile_dir / f"right_triangle_{filename}_ans.pdf"
    png_path_ans = currfile_dir / f"right_triangle_{filename}_ans.png"
