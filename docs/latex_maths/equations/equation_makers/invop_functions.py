...
def add_dict():
    ...
    kv["line2_LHSq"] = f"x + {nx} - \dotuline{{\hspace{{4mm}}}}"
    kv["line3_LHS"] = f"x"
    kv["line1_RHS"] = f"{na}"
    kv["line2_RHS"] = f"{na} - {nx}"
    kv["line2_RHSq"] = f"{na} - \dotuline{{\hspace{{4mm}}}}"
    kv["line3_RHS"] = f"{xval}"
    kv["line3_RHSq"] = f"\dotuline{{\hspace{{4mm}}}}"
    return kv
...
def times_dict():
    ...
    kv["line2_LHSq"] = f"\\frac{{{nx}x}}{{\dotuline{{\hspace{{4mm}}}}}}"
    kv["line3_LHS"] = f"x"
    kv["line1_RHS"] = f"{na}"
    kv["line2_RHS"] = f"\\frac{{{na}}}{{{nx}}}"
    kv["line2_RHSq"] = f"\\frac{{{na}}}{{\dotuline{{\hspace{{4mm}}}}}}"
    kv["line3_RHS"] = f"{xval}"
    kv["line3_RHSq"] = f"\dotuline{{\hspace{{4mm}}}}"
    return kv
...
def div_dict():
    ...
    kv["line2_LHSq"] = f"\\frac{{x}}{{{nx}}} \\times{{\dotuline{{\hspace{{4mm}}}}}}"
    kv["line3_LHS"] = f"x"
    kv["line1_RHS"] = f"{na}"
    kv["line2_RHS"] = f"{na} \\times{nx}"
    kv["line2_RHSq"] = f"{na} \\times{{\dotuline{{\hspace{{4mm}}}}}}"
    kv["line3_RHS"] = f"{xval}"
    kv["line3_RHSq"] = f"\dotuline{{\hspace{{4mm}}}}"
    return kv
