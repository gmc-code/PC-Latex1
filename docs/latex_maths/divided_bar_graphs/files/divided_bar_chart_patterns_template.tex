...
\newcommand{\mycyclelist}{
    cycle list={
        {pattern=vertical lines, pattern color=blue},
        {pattern=dots, pattern color=purple},
        {pattern=north east lines, pattern color=red},
        {pattern=crosshatch dots, pattern color=olive},
        {pattern=horizontal lines, pattern color=darkgray},
        {pattern=north west lines, pattern color=violet},
        {pattern=grid, pattern color=teal},
